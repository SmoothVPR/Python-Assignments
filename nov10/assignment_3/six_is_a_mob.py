...
class Game(object):
    ...
    - [x] If there are more than 5 people, a message is printed about there being a mob in the room.
    - [x] If there are 3-5 people, a message is printed about the room being crowded.
    - [x] If there are 1 or 2 people, a message is printed about the room not being crowded.
    - [x] If there are no people in the room, a message is printed about the room being empty.
    """
